...
public class ListDemo
{
    public static void main(String[] args) {
        ...
        /*
        The list iterator method creates a new iterator that is positioned at the front of the list
        The "|" in the comment to indicate the current iterator position
         */
